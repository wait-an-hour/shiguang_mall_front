...
export type MerchantWalletTransactionType =
...
export type MerchantWalletPage = PageView<MerchantWalletView>
...
export interface MerchantWalletOperator { id: Id; username: string; nickname: string }
export interface MerchantWalletTransactionView { id: Id; transactionNo: string; transactionType: MerchantWalletTransactionType; direction: MerchantTransactionDirection; sourceBucket: MerchantWalletBucket | null; targetBucket: MerchantWalletBucket | null; bucket: MerchantWalletBucket; amount: Money; pendingBefore: Money; pendingAfter: Money; availableBefore: Money; availableAfter: Money; frozenBefore: Money; frozenAfter: Money; businessType: string; businessNo: string; orderId: Id | null; orderNo: string | null; withdrawalId: Id | null; operator: MerchantWalletOperator | null; remark: string | null; createdAt: Timestamp }
