  ...
  <div class="inventory-page">
    ...
    <el-dialog v-model="dialogVisible" :title="dialogType === 'inbound' ? '采购入库' : '库存调整'" width="520px">
      <el-form :model="operationForm" label-width="90px">
        ...
        <el-form-item label="调整原因" :required="dialogType === 'adjustment'"><el-input v-model="operationForm.remark" type="textarea" :rows="3" maxlength="500" show-word-limit placeholder="请输入库存调整原因" /></el-form-item>
      </el-form>
