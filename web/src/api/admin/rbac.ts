...
import type { AccountStatus, Id, ListQuery, PlatformAccount, RoleRecord } from '@/types/admin'
...
export function setAccountStatus(id: Id, status: AccountStatus) { return mockAdmin.setAccountStatus(id, status) }
