...
import type { AccountStatus, ListQuery, PlatformAccount, RoleRecord } from '@/types/admin'
...
export function setAccountStatus(id: string, status: AccountStatus) { return mockAdmin.setAccountStatus(id, status) }
